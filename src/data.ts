...
export const projects = [
  ...
  {
    title: 'Embedded C++ Pro Starter',
    stack: 'C++, CMake, ARM GCC, GoogleTest, clang-tidy',
    summary:
      'Professional C++ starter template for embedded/firmware development with cross-compilation and CI-ready tooling.',
    highlights: [
      'CMake-based build system with ARM GCC cross-compilation.',
      'Unit testing with GoogleTest and static analysis (clang-tidy, cppcheck).',
      'Code formatting with clang-format and pre-commit hooks.'
    ]
  },
  {
    title: 'OpenGL Base',
    ...
    summary:
      'Minimal OpenGL starter project for learning and extending 3D graphics applications.',
    highlights: [
  ...
  {
    title: 'Image Compression GUI',
    stack: 'Python, PyQt5, PIL',
    summary:
      'Desktop application for batch image compression with an intuitive graphical interface.',
    highlights: [
      'PyQt5-based GUI with drag-and-drop support.',
      'Multiple compression formats and quality settings.',
